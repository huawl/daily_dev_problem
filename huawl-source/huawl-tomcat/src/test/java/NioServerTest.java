...
public class NioServerTest {
    ...
    public NioServerTest(int port) throws IOException {
        ...
        NioServerTest.print("Server Start----8888:");
    }
    ...
    private void handleKey(SelectionKey selectionKey) throws IOException {
        ...
        if (selectionKey.isAcceptable()) {
            ...
            if (count > 0) {
                ...
                NioServerTest.print("服务器端接受客户端数据--:"+receiveText);
                client.register(selector, SelectionKey.OP_WRITE);
            }
            NioServerTest.print("-----读取到准备写-----");
            ...
            NioServerTest.print("服务器端向客户端发送数据--："+sendText);
            client.register(selector, SelectionKey.OP_READ);
            NioServerTest.print("-----写完准备读-----");
        }
    }

    public static void main(String[] args) throws IOException {
        int port = 8888;
        NioServerTest server = new NioServerTest(port);
        server.listen();
    }
}
